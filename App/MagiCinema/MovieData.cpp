...
std::vector<Movie> GetMovieData()
{
    ...
    const char* createTableQuery = "CREATE TABLE IF NOT EXISTS movies (id INTEGER PRIMARY KEY, title TEXT, genre TEXT, release_date TEXT, show_time TEXT, days_of_week TEXT)";
    ...
    const char* insertQuery = "INSERT INTO movies (id, title, genre, release_date, show_time, days_of_week) VALUES (?, ?, ?, ?, ?, ?)";
    ...
    std::vector<Movie> movies = {
        { "Shrek 2", "Comedy/Family", "May 18, 2004", "9:00 PM", LoadTexture("../resources/Shrek.png"), { 0, 2, 6 } },
        { "The Martian", "Sci-fi/Adventure", "October 2, 2015", "10:30 AM", LoadTexture("../resources/TheMartian.png"), { 1, 3, 4, 6 } },
        { "The Batman", "Action/Adventure", "March 4, 2022", "1:00 PM", LoadTexture("../resources/TheBatman.png"), { 0, 3, 5 } },
        { "Spider-Man: No Way Home", "Action/Adventure", "December 17, 2021", "4:20 PM", LoadTexture("../resources/spider-man-no-way-home-art-collection.png"), { 1, 2, 4, 5 } },
    ...
    for (const Movie& movie : movies)
    {
        ...
        sqlite3_bind_text(statement, 2, movie.title.c_str(), -1, SQLITE_STATIC);
        sqlite3_bind_text(statement, 3, movie.genre.c_str(), -1, SQLITE_STATIC);
        sqlite3_bind_text(statement, 4, movie.releaseDate.c_str(), -1, SQLITE_STATIC);
        sqlite3_bind_text(statement, 5, movie.showtime.c_str(), -1, SQLITE_STATIC);
        sqlite3_bind_text(statement, 6, daysOfWeek.c_str(), -1, SQLITE_STATIC);
